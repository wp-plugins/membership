...
module.exports = function( grunt ) {
	var paths = {
		js_files_concat: {
			'js/select2.2.js':        ['js/vendor/select2.js'],
			'js/tiny-scrollbar.2.js': ['js/vendor/tiny-scrollbar.js'],
			'js/wpmu-ui.2.js':        [
				'js/src/wpmu-ui.js',
			...
			'js/wpmu-vnav.2.js':      ['js/src/wpmu-vnav.js'],
			'js/wpmu-card-list.2.js': ['js/src/wpmu-card-list.js']
		},

		css_files_compile: {
			'css/select2.2.css':          'css/sass/select2.scss',
			'css/wpmu-ui.2.css':          'css/sass/wpmu-ui.scss',
			'css/wpmu-vnav.2.css':        'css/sass/wpmu-vnav.scss',
			'css/wpmu-card-list.2.css':   'css/sass/wpmu-card-list.scss',
			'css/wpmu-html.2.css':        'css/sass/wpmu-html.scss',
			'css/fontawesome.2.css':      'css/sass/font-awesome/font-awesome.scss',
			'css/jquery-ui.wpmui.2.css':  'css/sass/jquery-ui/jquery-ui-1.10.4.custom.scss'
		},
